...
class LineEquipment extends StatelessWidget {
  ...
  static const htmlData = """<h3> <u>PHARMA TRAX LINE EQUIPMENT</u></h3> <br />
      ...
      <br /><h4>PHARMA TRAX CLOUD MODULE</h4> <br /><p>Pharma Trax Cloud provides the back-end data repository and reporting engine. It works with several of our check point modules like printing, verification and apps to provide complete traceability applications.</p> <br /><p>We provide Pharma Trax Cloud as a hosted application (SAAS - Software as a service); we can discuss the possibility of having a licensed private hosting at customer’s site for certain applications.</p> 
      <br /><h4>PHARMA TRAX APPS</h4> <br /><p>Pharma Trax app enables consumers to Identify and Track products using their own smart phones. We have mobile apps for Android, IOS, Windows CE platforms to allow consumers to access traceability information; these platforms are used within the organization for more detailed functions like internal logistics, sales or distribution applications.</p> 
      <br /><p>We can customize the apps to customer’s needs for applications like sales campaigns, data analytics, distribution channel management, Genuine product check.</p> 
      <br /><h4>PHARMA CLOUD</h4> 
      <br /><p>Pharma Trax Cloud provides the back-end data repository and reporting engine. It works with several of our check points and modules like Printing, Verification, Aggregation and allows various apps to provide Track and Trace functionality. We provide the cloud as a hosted application; we can discuss the possibility of having a licensed private hosting at customer’s site for certain applications.</p>
      <br />
      <p>For more details, please visit: <font color="#4A90CC">
      <a href="https://www.pharmatrax.pk/pharma-trax-cloud/">
        ...
        child: Stack(children: [
          ...
          Column(
            children: [
              ...
              Html(data: htmlData,
              style: {
                "h3":Style(color: Colors.grey),
                "h4":Style(color: Colors.grey),
                "p":Style(color:Colors.grey),
                "br":Style(color: Colors.grey),
                "a":Style(color: Colors.grey),
              },
              // onLinkTap: (Url){
              //   print("open the $Url .....");
              // },
